    ...
    <div class="container how-sore-throat">
        <div class="row pt-3">
            <div class="col-12 offset-md-2 col-md-8">
                <vm-progress :percentage="55" :show-text="false" :stroke-width="18" :strokeColor="'#2bb1c4'"></vm-progress>
            </div>
        </div>
        <div class="row row-img">
            <div class="col-12 text-center">
                <img src="../assets/corona-14.png">
            </div>
        </div>
        <div class="row pt-5 pb-1">
            <div class="offset-2 col-8 text-center">
                <label class="title">{{ $t('howMuscleAches.title') }}</label>
            </div>
        </div>
        <div class="row pt-4">
...
export default {
    ...
    methods: {
        nextPage: function() {
            const answer = {
                key: 'muscle_aches_level',
                value: this.level
            }

            this.$store.commit('SET_DATA_SURVEY', answer)

            this.$router.push({ name: 'YouHaveCough' })      
        }
    }
}
</script>
...
.how-sore-throat .label-option {
    margin-bottom: 20px;
}

.how-sore-throat .row-next {
    padding-top: 5.5rem;
}

.how-sore-throat .next {
    width: 80%;
    min-height: 83px;
    font-weight: 300;
    border-radius: 15px;
...
.how-sore-throat input[type='radio'] {
...
.how-sore-throat input[type='radio']:hover {
    box-shadow: none;
}

.how-sore-throat input[type='radio']:before {
    content:'';
    display:block;
    width:60%;
    height:60%;
...
.how-sore-throat input[type='radio']:checked:before {
    background:#2bb1c4;
}
</style>